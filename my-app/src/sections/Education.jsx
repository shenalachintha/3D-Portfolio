...
const education = [
  {
    degree: "Undergraduate in BSc in Computer Science",
    school: "Eastern University, Sri Lanka",
    location: "Sri Lanka",
    period: "2026 — Present",
  },
  {
    degree: "G.C.E. A/L Examination (Physical Science Stream)",
    school: "Chilaw Ananda National College",
    location: "Sri Lanka",
    period: "2021",
  },
];
...
export const Education = () => {
  return (
    <section id="education" className="py-24 sm:py-28 relative overflow-hidden">
      ...
      <div className="container mx-auto px-6 relative z-10">
        ...
        <div className="relative max-w-5xl mx-auto">
          <div className="absolute left-4 sm:left-6 top-0 bottom-0 border-l border-border/60" aria-hidden />

          <div className="space-y-10">
            {education.map((item, idx) => (
              <div
                key={item.degree}
                className="relative pl-10 sm:pl-12 animate-fade-in"
                style={{ animationDelay: `${(idx + 1) * 140}ms` }}
              >
                <div className="absolute left-0 top-5 w-3 h-3 rounded-full bg-primary timeline-glow" />

                <div className="glass rounded-2xl p-5 sm:p-6 border border-border/60 hover:border-primary/60 transition-all duration-300">
